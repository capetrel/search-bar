...
<div id="" class="Bloc-de-texte-standard">
    <h1 class="h1">Données Suite</h1><br>
    <br><br>

    <p class="paragraphe">Généralement, on utilise un texte en faux latin (le texte ne veut rien dire, il a été modifié), le Lorem ipsum ou Lipsum, qui permet donc de faire office de texte d'attente. L'avantage de le mettre en latin est que l'opérateur sait au premier coup d'oeil que la page contenant ces lignes n'est pas valide, et surtout l'attention du client n'est pas dérangée par le contenu, il demeure concentré seulement sur l'aspect graphique. Exemple</p>
    <br>
    <p class="paragraphe">
    ...
    <br>
    <p class="paragraphe">Il circule des centaines de versions <strong>différentes du Lorem ipsum</strong>, mais ce texte aurait originellement été tiré de l'ouvrage de Cicéron, De Finibus Bonorum et Malorum (Liber Primus, 32), texte populaire à cette époque, dont l'une des premières phrases est : « Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit... » (« Il n'existe personne qui aime la souffrance pour elle-même, <i>ni qui la recherche ni qui la veuille</i> pour ce qu'elle est... »).</p>
    <br>
